...
// end include: /tmp/tmpcfwb893x.js
// include: /tmp/tmppnk8cl40.js
...
// end include: /tmp/tmppnk8cl40.js
// include: /tmp/tmp_idseukc.js
...
// end include: /tmp/tmp_idseukc.js
...
var ASM_CONSTS = {
  ...
  620408: () => Module["SDL3"].audioContext.sampleRate,
  620459: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  626004: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  626063: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  631159: () => window.innerWidth,
  631189: () => window.innerHeight
};
